      ...
      <nav className='container mx-auto flex items-center justify-between py-4 px-6 '>
        <div>
          <Link to="/" className="flex items-center space-x-2">
            <FaShopify className="text-3xl sm:text-4xl md:text-5xl text-green-600" />
            <span className="hidden xs:inline sm:inline text-[15px] md:text-3xl font-semibold">ShopMart</span>
          </Link>
        </div>
        ...
        <div className='flex items-center space-x-4'>
          ...
          <button onClick={toggleCarDrawer} className='relative hover:text-black'>
            ...
            {cartItemCount > 0 && (<span className='absolute -top-0.5 bg-rabbit-red text-white text-xs rounded-full px-2 py-0.5'>
              {cartItemCount}
            </span>
            )}
          </button>
